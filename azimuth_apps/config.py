...
class HelmClientConfiguration(Section):
    ...
    default_timeout: conint(gt=0) | constr(min_length=1) = "1h"
...
class ZenithOperatorConfiguration(Section):
    ...
    kubeconfig_secret_label: constr(min_length=1) = (
    ...
    #: In particular, this should include the Zenith registrar and SSHD connection
    #: details
